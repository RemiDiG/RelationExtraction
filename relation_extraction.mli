...
val relation_extraction_single :
 opaque_access:Global.indirect_accessor -> (string option * Libnames.qualid * int list * recursion_style option) list -> unit
...
val relation_extraction_fixpoint :
  (string option * Libnames.qualid * int list * recursion_style option) list -> unit
